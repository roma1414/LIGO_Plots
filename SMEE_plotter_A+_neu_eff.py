...
dist_1 = [1, 2, 5, 10, 15, 20, 50, 75]
logBsn_1 = [.997, .9, .706, .442, .272, .172, 0, 0]
dist_2 = [1, 2, 5, 10, 15, 20, 50, 100, 150]
logBsn_2 = [1, .944, .122, .006, 0, 0, 0, 0, 0]
'''dist_3 = [1, 2, 5, 10, 15, 20, 50, 75]
logBsn_3 = [.997, .9, .706, .442, .272, .172, 0, 0]
dist_4 = [1, 2, 5, 10, 15, 20, 50, 100, 150]
logBsn_4 = [1, .944, .122, .006, 0, 0, 0, 0, 0]'''
