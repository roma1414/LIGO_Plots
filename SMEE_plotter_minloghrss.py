...
plot_name = 'minloghrss.png'#'FFT_vs_Spec_sch.png'
title = 'logBsn vs minloghrss Prior'#'log Bsn vs Distance for sch_10, Sch PCs'
...
dist_1 = [-59, -57, -55, -54, -53, -52, -51, -50, -49, -48, -47, -45, -41]
logBsn_1 = [-0.04, 19, 24, 28.1, 24.1, 22.7, 16.9, 16.6, 2, -2.4, -11, -11.8, -16.6]
dist_2 = [-59, -57, -55, -54, -53, -52, -51, -50, -49, -48, -47, -45, -43, -41]
logBsn_2 = [23.2, 17.5, 29.9, 28.4, 28.5, 23.3, 26.2, 29.3, 18.2, 3.1, 1.4, 9.9, 0.78, -8.6]
dist_3 = [-59, -57, -55, -54, -53, -52, -51, -50, -49, -48, -47, -45]
logBsn_3 = [39.2, 24.5, 37.4, 46.2, 47.7, 29.6, -37.9, -638, -7970, -76978, -636457, -36956664]
dist_4 = [-59, -57, -55, -54, -53, -52, -51, -50, -49, -48, -47, -45]
logBsn_4 = [-0.07, 57.9, 57.6, 66.3, 63.4, 36.8, -26.3, -1190, -18584, -190176, -1610182, -95236068]
'''dist_5 = [10, 20, 30, 50, 75, 100, 150, 200, 250, 300, 400, 500, 600, 700]
logBsn_5 = [1, 1, 1, 1, 1, 1, 1, .972, .894, .789, .7, .572, .417, .322]'''
...
plt.plot(dist_1, logBsn_1, 'b-', zorder = 8, label='ET (1) - Neu PCs')
print('1')
plt.plot(dist_2, logBsn_2, 'g-', zorder = 7, label='ET (1) - Sch PCs')
print('2')
plt.plot(dist_3, logBsn_3, 'y-', zorder = 6, label='ET (3), Voy (3) - Neu PCs')
print('3')
plt.plot(dist_4, logBsn_4, 'r-', zorder = 5, label='ET (3), Voy (3) - Sch PCs')
print('4')
'''plt.plot(dist_5, logBsn_5, 'k-', zorder = 4, label='CE (1), ET (3)')
print('5')
plt.plot(snr_6, logBsn_6, 'mo-', zorder = 3, label='Scheidegger2010_R5E1AC')
print('6')
...
plt.xlim([-59, -41])
plt.ylim([-50, 50])
plt.xlabel('Minimum loghrss Prior', fontsize=18)
plt.ylabel('logBsn', fontsize=18)#'Efficiency')
