...
dist_1 = [5, 10, 20, 30, 50, 75, 100, 150, 200, 250]
logBsn_1 = [1, 1, .905, .842, .631, .419, .25, .147, .081, .089]
dist_2 = [10, 20, 30, 50, 75, 100, 150, 200, 250, 300]
logBsn_2 = [1, 1, .883, .803, .611, .425, .225, .133, .111, .067]
dist_3 = [10, 20, 30, 50, 75, 100, 150, 200, 250, 300, 350]
logBsn_3 = [1, 1, 1, .922, .781, .753, .569, .339, .233, .122, .122]
dist_4 = [10, 20, 30, 50, 75, 100, 150, 200, 500, 750, 1000]
logBsn_4 = [1, 1, 1, 1, .925, .919, .755, .656, .219, .045, .047]
dist_5 = [20, 30, 50, 75, 100, 150, 200, 250, 300, 500, 750, 1000, 1500, 2000]
logBsn_5 = [1, 1, 1, 1, 1, .894, .819, .767, .656, .428, .158, .067, .036, 0]
...
print('3')
plt.plot(dist_4, logBsn_4, 'r-', zorder = 5, label='ET (3), Voyager (3)')
print('4')
