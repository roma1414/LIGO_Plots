...
plot_name = 'model_comparison_sch_dist_2.png'#'FFT_vs_Spec_sch.png'
title = 'logBsn vs Distance for Sheidegger Waveforms'#'log Bsn vs Distance for sch_10, Sch PCs'
...
dist_1 = [1.53, 2, 2.5, 2.65, 2.85, 3, 3.25, 13, 20, 30, 40, 50, 60, 65]
logBsn_1 = [262054, 152543, 97420, 86781, 74757, 67469, 57373, 3007, 1044, 322, 97, 28.4, -.77, -.79]
dist_2 = [2, 2.5, 2.65, 2.85, 3, 3.25, 13, 20, 30, 40, 50, 60, 65]
logBsn_2 = [148029, 95297, 84448, 73036, 65089, 55955, 2867, 980, 285, 91, 18.9, 0.78, -.8]
dist_3 = [1.53, 2, 2.5, 2.65, 2.85, 3, 3.25, 13, 20, 30, 40, 50, 60, 65]
logBsn_3 = [46737, 27403, 17568, 15642, 13536, 12218, 10419, 657, 273, 117, 59.5, 37, 22.6, 17.7]
dist_4 = [1.53, 2, 2.5, 2.65, 2.85, 3, 3.25, 13, 20, 30, 40, 50, 60, 65]
logBsn_4 = [45717, 26805, 17186, 15304, 13241, 11955, 10194, 639, 267, 111, 58, 35, 21.4, 15.9]
...
plt.plot(dist_1, logBsn_1, 'bo-', zorder = 8, label='SPEC - Scheidegger2010_R3E1AC.txt*')
print('1')
plt.plot(dist_2, logBsn_2, 'go-', zorder = 7, label='SPEC - Scheidegger2010_R3E1DB.txt')
print('2')
plt.plot(dist_3, logBsn_3, 'yo-', zorder = 6, label='FFT - Scheidegger2010_R3E1AC.txt')
print('3')
plt.plot(dist_4, logBsn_4, 'ro-', zorder = 5, label='FFT - Scheidegger2010_R3E1DB.txt')
print('4')
...
plt.xlim([13, 65])
plt.ylim([0, 400])
plt.xlabel('Injection Distance [kpc]')
plt.ylabel('log Bsn')#'Efficiency')
