...
plot_name = 'model_selection_neu_dist.png'#'FFT_vs_Spec_sch.png'
title = 'Model Selection for Neutrino Waveforms'#'log Bsn vs Distance for sch_10, Sch PCs'
...
logBsn_1 = [130, 75, 22.2, 11.7, .39, .18, .12, 0, 0, 0, 0, 0, 0, 0]
dist_2 = [1.53, 2, 2.5, 2.65, 2.85, 3, 3.25, 13, 20, 30, 40, 50, 60, 65]
logBsn_2 = [1607, 820, 447, 376, 303, 250, 201, .39, 0, 0, 0, 0, 0, 0]
dist_3 = [1.53, 2, 2.5, 2.65, 2.85, 3, 3.25, 13, 20, 30, 40, 50, 60, 65]
logBsn_3 = [319, 169, 97, 85, 71, 57, 47, 0, 0, 0, 0, 0, 0, 0]
...
plt.ylabel('log Bm1m2')#'Efficiency')
