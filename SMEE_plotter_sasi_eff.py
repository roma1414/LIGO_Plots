...
plot_name = 'eff_sasi.png'#'FFT_vs_Spec_sch.png'
title = 'Efficiency for SASI Classification'#'log Bsn vs Distance for sch_10, Sch PCs'
...
logBsn_1 = [1, .92, .56, .3, .01, 0, 0]
dist_2 = [2, 10, 20, 30, 40, 50, 75, 100, 125]
logBsn_2 = [1, .94, .525, .16, .005, 0, 0, 0, 0]
dist_3 = [2, 10, 20, 30, 40, 50, 75, 100, 125]
logBsn_3 = [1, .99, .585, .25, .03, 0, 0, 0, 0]
dist_4 = [2, 10, 30, 50, 75, 100, 125, 150, 200]
logBsn_4 = [1, 1, .795, .505, .385, .18, .06, .005, 0]
dist_5 = [2, 10, 30, 50, 75, 100, 125, 150, 200, 250]
logBsn_5 = [1, 1, .98, .85, .66, .44, .35, .23, .01, 0]
