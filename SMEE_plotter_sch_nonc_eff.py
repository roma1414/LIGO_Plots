...
plot_name = 'sch_eff_nonc.png'#'FFT_vs_Spec_sch.png'
title = 'Efficiency for Non-Catalog Scheidegger Waveforms'#'log Bsn vs Distance for sch_10, Sch PCs'
...
dist_1 = [2, 10, 30, 50, 75, 100, 150, 200, 250, 300]
logBsn_1 = [1, 1, .86, .69, .53, .37, .21, .11, .03, 0]
dist_2 = [2, 10, 30, 50, 75, 100, 150, 300, 400, 450]
logBsn_2 = [1, 1, .97, .89, .74, .61, .38, .12, .02, 0]
dist_3 = [2, 10, 30, 50, 75, 100, 150, 300, 400, 475]
logBsn_3 = [1, 1, 1, .89, .86, .76, .49, .16, .04, 0]
dist_4 = [10, 30, 50, 75, 100, 150, 200, 250, 500, 600, 700, 800, 900, 1100]
logBsn_4 = [1, 1, 1, .99, .97, .93, .86, .79, .36, .33, .26, .12, .04, 0]
dist_5 = [10, 30, 50, 75, 100, 150, 200, 250, 300, 350, 400, 450, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700]
logBsn_5 = [1, 1, 1, 1, 1, .99, .97, .94, .89, .84, .76, .72, .46, .36, .31, .27, .23, .2, .12, .1, .09, .067, .05]
...
plt.plot(dist_1, logBsn_1, 'b-', zorder = 8, label='A+ (2), aVirgo (1), Kagra (1)')
print('1')
plt.plot(dist_2, logBsn_2, 'g-', zorder = 7, label='Voyager (2), aVirgo (1), Kagra (1)')
print('2')
plt.plot(dist_3, logBsn_3, 'y-', zorder = 6, label='Voyager (3), aVirgo (1), Kagra (1)')
print('3')
plt.plot(dist_4, logBsn_4, 'r-', zorder = 5, label='ET (3), Voyager (2)')
print('4')
