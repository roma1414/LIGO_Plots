...
plot_name = 'comparison_neu_dist_2.png'#'FFT_vs_Spec_sch.png'
title = 'logBsn vs Distance for Neutrino Waveforms'#'log Bsn vs Distance for sch_10, Sch PCs'
...
logBsn_1 = [302, 94, 21.4, 10.9, -.59, -.62, -.68, -.79, -.78, -.78, -.78, -.78, -.81, -.91]
dist_2 = [1.53, 2, 2.5, 2.65, 2.85, 3, 3.25, 13, 20, 30, 40, 50, 60, 65]
logBsn_2 = [1606, 819, 446, 375, 302, 249, 200, -.59, -.79, -.8, -.8, -.8, -.8, -.8]
dist_3 = [1.53, 2, 2.5, 2.65, 2.85, 3, 3.25, 13, 20, 30, 40, 50, 60, 65]
logBsn_3 = [358, 187, 104, 89, 73, 58, 47, -.58, -.6, -.6, -.6, -.6, -.6, -.6]
dist_4 = [1.53, 2, 2.5, 2.65, 2.85, 3, 3.25, 13, 20, 30, 40, 50, 60, 65]
logBsn_4 = [396, 220, 131, 113, 95, 84, 68, -.4, -.4, -.4, -.4, -.4, -.4, -.4]
...
plt.plot(dist_1, logBsn_1, 'bo-', zorder = 8, label='SPEC - Andresen2016_s20.txt*')
print('1')
plt.plot(dist_2, logBsn_2, 'go-', zorder = 7, label='SPEC - Mueller2012_L15-3.txt')
print('2')
plt.plot(dist_3, logBsn_3, 'yo-', zorder = 6, label='FFT - Andresen2016_s20.txt')
print('3')
plt.plot(dist_4, logBsn_4, 'ro-', zorder = 5, label='FFT - Mueller2012_L15-3.txt')
print('4')
