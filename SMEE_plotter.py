...
plot_name = 'neu_A+.png'#'FFT_vs_Spec_sch.png'
title = 'Model Selection Efficiency for Neutrino Waveforms'#'log Bsn vs Distance for sch_10, Sch PCs'
...
logBsn_1 = [.997, .897, .706, .45, .276, .178, .081, 0, 0, 0, 0]
dist_2 = [1, 2, 4, 5, 10, 15, 20, 50, 75, 100, 150]
logBsn_2 = [1, .933, .478, .022, 0, 0, 0, 0, 0, 0, 0]
dist_3 = [1.53, 2, 2.5, 2.65, 2.85, 3, 3.25, 13, 20, 30, 40, 50, 60, 65]
logBsn_3 = [0, 0, 0, 0, 0, 0, 0, 653, 274, 118, 60, 37.5, 23, 18]
dist_4 = [1.53, 2, 2.5, 2.65, 2.85, 3, 3.25, 13, 20, 30, 40, 50, 60, 65]
logBsn_4 = [0, 0, 0, 0, 0, 0, 0, 636, 268, 112, 59, 36, 22, 16.5]
...
print('2')
plt.plot(dist_3, logBsn_3, 'y-', zorder = 6, label='A+/Kagra Catalog')
print('3')
