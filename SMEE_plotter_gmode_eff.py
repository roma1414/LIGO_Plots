...
plot_name = 'eff_gmode.png'#'FFT_vs_Spec_sch.png'
title = 'Efficiency for g-Mode Classification'#'log Bsn vs Distance for sch_10, Sch PCs'
...
dist_1 = [2, 5, 10, 20, 30, 50, 75]
logBsn_1 = [1, .965, .63, .45, .295, .045, 0]
dist_2 = [2, 10, 20, 30, 40, 50, 75, 100, 125]
logBsn_2 = [1, .94, .595, .42, .3, .22, .02, 0, 0]
dist_3 = [2, 10, 20, 30, 40, 50, 75, 100, 125]
logBsn_3 = [1, .99, .685, .475, .42, .295, .045, .01, 0]
dist_4 = [2, 10, 30, 50, 75, 100, 125, 150, 200, 250, 300]
logBsn_4 = [1, 1, .9, .53, .485, .44, .4, .32, .18, .005, 0]
dist_5 = [2, 10, 30, 50, 75, 100, 125, 150, 200, 250, 300, 350, 400]
logBsn_5 = [1, 1, 1, .88, .695, .53, .49, .435, .31, .185, .09, .035, .015]
