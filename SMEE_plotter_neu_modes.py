...
plot_name = 'neu_modes_A+.png'#'FFT_vs_Spec_sch.png'
title = 'A+ Classification Accuracy'#'log Bsn vs Distance for sch_10, Sch PCs'
...
dist_2 = [5, 10, 30, 50]
logBsn_2 = [.489, .407, .067, 0]
dist_3 = [5, 10, 30, 50]
logBsn_3 = [.481, .193, .007, 0]
dist_4 = [5, 10, 30, 50]
logBsn_4 = [.7, .563, .115, .063]
dist_5 = [5, 10, 30, 50]
logBsn_5 = [.4, .426, .033, .041]
...
plt.plot(dist_1, logBsn_1, 'b-', zorder = 8, label='Neutrino Mechanism (non-catalog)')
print('1')
plt.plot(dist_2, logBsn_2, 'g-', zorder = 7, label='Has G-Modes')
print('2')
plt.plot(dist_3, logBsn_3, 'y-', zorder = 6, label='Has No G-Modes')
print('3')
plt.plot(dist_4, logBsn_4, 'r-', zorder = 5, label='Has SASI')
print('4')
plt.plot(dist_5, logBsn_5, 'k-', zorder = 4, label='Has No SASI')
print('5')
'''plt.plot(dist_6, logBsn_6, 'm-', zorder = 3, label='Scheidegger2010_R5E1AC')
print('6')
