...
plot_name = 'sch_eff_cat.png'#'FFT_vs_Spec_sch.png'
title = 'Efficiency for Catalog Scheidegger Waveforms'#'log Bsn vs Distance for sch_10, Sch PCs'
...
logBsn_1 = [1, .96, .76, .53, .39, .26, .11, .04, .01, 0]
dist_2 = [2, 10, 30, 50, 75, 100, 150, 300, 400, 450]
logBsn_2 = [1, .99, .87, .72, .56, .43, .27, .05, .01, 0]
dist_3 = [2, 10, 30, 50, 75, 100, 150, 300, 400, 450]
logBsn_3 = [1, 1, .91, .76, .6, .47, .31, .07, .02, 0]
dist_4 = [10, 30, 50, 75, 100, 150, 200, 250, 500, 600, 700, 800, 900, 1000]
logBsn_4 = [1, 1, 1, .99, .97, .9, .83, .73, .34, .26, .15, .08, .01, 0]
dist_5 = [10, 30, 50, 75, 100, 150, 200, 250, 300, 350, 400, 450, 700, 800, 900, 1000, 1100, 1200, 1300, 1400, 1500, 1600, 1700]
logBsn_5 = [1, 1, 1, 1, 1, .98, .96, .92, .86, .81, .73, .69, .44, .33, .29, .23, .2, .15, .1, .07, .04, .025, 0]
