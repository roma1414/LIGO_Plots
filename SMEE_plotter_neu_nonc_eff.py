...
dist_1 = [2, 10, 30, 50, 75, 100, 150, 200, 250]
logBsn_1 = [1, .56, .25, .03, 0, 0, 0, 0, 0]
dist_2 = [2, 10, 30, 50, 75, 100, 150, 300, 400]
logBsn_2 = [1, .94, .39, .18, .01, 0, 0, 0, 0]
dist_3 = [2, 10, 30, 50, 75, 100, 150, 300, 400]
logBsn_3 = [1, .99, .48, .18, .03, 0, 0, 0, 0]
dist_4 = [10, 30, 50, 75, 100, 150, 200, 250, 500, 600, 700, 800, 900]
logBsn_4 = [1, .86, .52, .48, .43, .26, .02, .01, 0, 0, 0, 0, 0]
dist_5 = [10, 30, 50, 75, 100, 150, 200, 250, 300, 350, 400, 450, 700, 800, 900, 1000]
logBsn_5 = [1, .98, .88, .58, .5, .42, .28, .14, .03, .005, 0, 0, 0, 0, 0, 0]
