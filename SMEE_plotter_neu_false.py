...
plot_name = 'neu_false_sasi_A+.png'#'FFT_vs_Spec_sch.png'
title = 'SASI A+ Classification Accuracy'#'log Bsn vs Distance for sch_10, Sch PCs'
...
dist_1 = [5, 10, 30, 50]
logBsn_1 = [.7, .563, .115, .063]
dist_2 = [5, 10, 30, 50]
logBsn_2 = [.4, .426, .033, .041]
dist_3 = [5, 10, 30, 50]
logBsn_3 = [.022, .074, .074, .037]
dist_4 = [5, 10, 30, 50]
logBsn_4 = [.011, 0, 0, 0]
...
plt.plot(dist_1, logBsn_1, 'b-', zorder = 8, label='Correctly Classified SASI')
print('1')
plt.plot(dist_2, logBsn_2, 'g-', zorder = 7, label='Correctly Classified No SASI')
print('2')
plt.plot(dist_3, logBsn_3, 'y-', zorder = 6, label='Inccorectly Classified SASI')
print('3')
plt.plot(dist_4, logBsn_4, 'r-', zorder = 5, label='Inccorectly Classified No SASI')
print('4')
