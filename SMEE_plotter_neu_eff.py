...
plot_name = 'neu_eff_nonc.png'#'FFT_vs_Spec_sch.png'
title = 'Efficiency for Non-Catalog Neutrino Waveforms'#'log Bsn vs Distance for sch_10, Sch PCs'
...
logBsn_1 = [.694, .511, .433, .228, .1, .05, 0, 0, 0, 0]
dist_2 = [10, 20, 30, 50, 75, 100, 150, 200, 250, 300]
logBsn_2 = [.678, .506, .433, .144, .1, .044, .001, .011, 0, 0]
dist_3 = [10, 20, 30, 50, 75, 100, 150, 200, 250, 300]
logBsn_3 = [.756, .5, .5, .372, .111, .05, 0, 0, 0, 0]
dist_4 = [10, 20, 30, 50, 75, 100, 150, 200, 500, 750, 1000, 1500]
logBsn_4 = [1, .767, .511, .517, .506, .333, .217, .033, .001, 0, 0, 0]
dist_5 = [20, 30, 50, 75, 100, 150, 200, 250, 500, 750, 1000, 1500, 2000]
logBsn_5 = [1, .894, .611, .528, .5, .489, .233, .156, 0, 0, 0, 0, 0]
